...
if sidebar=='Home':
    ...
    st.write('My name is Bishal you can mail me on emai ID given below')
    st.image('https://mailmeteor.com/logos/assets/PNG/Gmail_Logo_256px.png',width=100)
    st.write(':point_right:', 'bishalkumardasofficial11@gmail.com')

    st.write('and my linkdin account through given link below')
    ...
    st.write('and my Instagram link is given below this line')
...
if sidebar=='Tweeter Analysis':
    st.image('https://images.tv9hindi.com/wp-content/uploads/2022/04/twitter-deal.jpg', width=300)
    st.info('All the analysis in this page have been done on last 100 tweets of the use')
    ...
    n=st.number_input('Write the number of last tweet you want', min_value=1, step=1, max_value=100)
    ...
    if st.button('Show sentiments'):
        ...
        fig, ax = plt.subplots()
        sns.barplot(sentiment.index, sentiment.values, ax=ax)
